...
girl2 = User.create({email:'cheryl@email.com', username:"KeepItCheryeal", gender: "woman", password:"password", password_confirmation: "password", birthday: 19940103, height: 60, body_type: "no answer", relationship_status: "divorced", have_children: true, number_children: 2, want_children: "yes", education_level: "graduate degree", smoker: "occasionally", drinker: "social drinker", ethnicity: "latino,", religion:"jewish", salary:"$100,001 to $150,000", bio:"Must love dogs", zipcode: 60615, personality: "ENTP", admin_level:0})

girl3 = User.create({email:'vanessa@email.com', username:"VWVan", gender: "woman", password:"password", password_confirmation: "password", birthday: 19800927, height: 61, body_type: "athletic and toned", relationship_status: "never married", have_children: false, number_children: 0, want_children: "no", education_level: "no answer", smoker: "no way", drinker: "never", ethnicity: "asian, other,", religion:"atheist", salary:"$75,001 to $100,000", bio:"Must hate cats", zipcode: 60640, personality: "INFJ", admin_level:0})

preference1 = Preference.create({user:User.find(1), gender: "woman", minimum_age:22, maximum_age:30, body_type:"slender,athletic and toned,stocky", relationship_status:"never married,widow | widower", has_children:"no", smokes: "no way,occasionally,cigar aficionado", drinks: "social drinker,regularly,moderately", ethnicity: "white,black,asian", maximum_height: 70, minimum_height:55, religion: "atheist,jewish,other", education:"bachelors degree,graduate degree,phd / post doctoral", dealbreaker: "smokes", most_important: "drinks", personalities: "INFP,ENFP,INFJ,ENFJ,INTP,ENTP,ISFP"})
